                                ...
                                <div class="useraddFormContainer">
                                    <form action="database/add.php" method="POST" class="appForm"
                                        ...
                                        <div class="appFormInputContainer">
                                            ...
                                            <input type="text" id="supplier_name" placeholder="Enter the supplier name..."
                                                class="appFormInput" name="supplier_name" />
                                        </div>
                                        <div class="appFormInputContainer">
                                            <label for="supplier_location">Location</label>
                                            <input type="text" id="supplier_location"
                                                placeholder="Give product supplier location..." class="appFormInput"
                                                name="supplier_location"></input>
                                        </div>
                                        <div class="appFormInputContainer">
                                            <label for="email">Email</label>
                                            <input type="text" id="email" placeholder="Give product supplier email..."
