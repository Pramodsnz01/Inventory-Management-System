                            ...
                            <div class="useraddFormContainer">
                                <form action="database/add.php" method="POST" class="appForm" enctype="multipart/form-data">
                                    <div class="appFormInputContainer">
                                        ...
                                        <input type="text" id="product_name" placeholder="Enter the product name..." class="appFormInput" name="product_name" />
                                    </div>
                                    <div class="appFormInputContainer">
                                        <label for="description">Description</label>
                                        <textarea id="description" placeholder="Give product short description..." class="appFormInput productTextAreaInput" name="description"></textarea> 
                                    </div> 
                                    <div class="appFormInputContainer">
